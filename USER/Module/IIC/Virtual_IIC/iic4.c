...
#define SCL_L   (I2C_MONI_SCL_GPIO4->BSRR = (I2C_MONI_SCL_PIN4 << 16))
#define SCL_H   (I2C_MONI_SCL_GPIO4->BSRR =  I2C_MONI_SCL_PIN4)
#define SDA_L   (I2C_MONI_SDA_GPIO4->BSRR = (I2C_MONI_SDA_PIN4 << 16))
#define SDA_H   (I2C_MONI_SDA_GPIO4->BSRR =  I2C_MONI_SDA_PIN4)
#define SDA_READ   ((I2C_MONI_SDA_GPIO4->IDR & I2C_MONI_SDA_PIN4)?1:0)
...
void MT6701_Init_4(MT6701_Encoder_t *encoder) {
    ...
    encoder->first_raw_angle = get_raw_angle_4();
...
// encoder：编码器结构体指针
void MT6701_SetZero_4(MT6701_Encoder_t *encoder) {
    ...
    encoder->raw_zero =get_raw_angle_4();
}
void MT6701_Update_4(MT6701_Encoder_t *encoder) {
    // 步骤1：仅读取1次原始角度（避免I2C冗余读取）
    encoder->raw_angle = get_raw_angle_4();

    // 步骤2：计算单圈相对零点的实际角度
    get_real_angle_4(encoder);
